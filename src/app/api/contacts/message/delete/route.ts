...
export async function POST(request: Request){
    ...
    // Delete the message where the contact id is the same as "to" or "from" and the content is the same as the message content
    
    await Message.deleteOne({content: messageContent, $or: [{to: contactId}, {from: contactId}]});
